...
# TODO: this code's foundational structure is broken because it was generated by ChatGPT. It needs to be changed so it can actually handle HTTP requests in a multithreaded manner. there is no method on $runspacePool for QueueScriptBlock.
